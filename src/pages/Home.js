    ...
    <div className="flex-container">
      <div className="boxes">
        <div className="box1-container">
            <img className="white-background-1" alt="White background" src="../../Assets/carandstreet.png"/>
            <img className="city-driver-img" alt="A driver leaning on a car" src="../../Assets/city-driver-bro-1.png"/>
        ...
        <div className="box2-container">
            <img className="white-background-2" alt="White background" src="../../Assets/redlocationicon.png"/>
            <img className="city-skyline-img" alt="A view of a park with a city in the background" src="../../Assets/city-skyline-bro-1.png"/>
        ...
        <div className="box3-container">
            <img className="white-background-3" alt="White background" src="../../Assets/redlocationicon.png"/>
            <img className="navigation-bro" alt="Guy using gps to navigate" src="../../Assets/navigation-bro-1.png"/>
